...
public class CharacterShopPriceAndList : MonoBehaviour
{
    public static Dictionary<string, ArrayList> CharacterPool = new Dictionary<string, ArrayList>()
    {
        ...
        {"王小", new ArrayList(){false,CharacterArtCode.女布衣, new  List<Tag>() { Tag.才华横溢, Tag.小有谋略, Tag.东洋语, Tag.能歌善舞, Tag.不孕不育 }, new List<int>(){3000,0,0} } },
        {"诗飞兰", new ArrayList(){false, CharacterArtCode.舞女, new  List<Tag>() { Tag.长袖善舞, Tag.通晓天文, Tag.离经叛道, Tag.演员, Tag.体态端正 }, new List<int>(){3000,0,0} } },
        {"任谷雪", new ArrayList(){false, CharacterArtCode.舞女, new  List<Tag>() { Tag.妙手丹心, Tag.小有谋略, Tag.西洋语, Tag.演员, Tag.不孕不育 }, new List<int>(){3000,0,0} } },
        {"诗音书", new ArrayList(){false, CharacterArtCode.舞女, new  List<Tag>() { Tag.通晓天文, Tag.东洋语, Tag.能歌善舞, Tag.体态端正, Tag.不孕不育 }, new List<int>(){3000,0,0} } },
        {"东方夏沁", new ArrayList(){false, CharacterArtCode.舞女, new  List<Tag>() { Tag.略有才名, Tag.长袖善舞, Tag.棋道, Tag.根骨清奇, Tag.体态端正 }, new List<int>(){3000,0,0} } },
        {"双南静", new ArrayList(){false, CharacterArtCode.舞女, new  List<Tag>() { Tag.长袖善舞, Tag.心算, Tag.离经叛道, Tag.演员, Tag.体态端正 }, new List<int>(){3000,0,0} } },
        {"雪妙忆", new ArrayList(){false, CharacterArtCode.舞女, new  List<Tag>() { Tag.长袖善舞, Tag.琴师, Tag.外乡人, Tag.珠光宝气, Tag.辟邪安正 }, new List<int>(){3000,0,0} } },
    };
    ...
    {
        {"栾千雪", new ArrayList(){false,CharacterArtCode.女布衣, new  List<Tag>() { Tag.诗仙, Tag.才华横溢, Tag.仁人君子, Tag.琴师, Tag.不孕不育 }, new List<int>(){12000,0,0} } },
        {"问音晓", new ArrayList(){false, CharacterArtCode.女布衣, new  List<Tag>() { Tag.窥得天机, Tag.书通二酉, Tag.阳明学派, Tag.妙手丹心, Tag.不孕不育 }, new List<int>(){12000,0,0} } },
    };
