...
public class Player : MonoBehaviour
{
    ...
    public static Dictionary<Tag, List<int>> TagInfDict = new Dictionary<Tag, List<int>>() {
        ...
        {Tag.铁王八,new List<int>(){0,0,0,0,-12,12}},
        {Tag.虎虎生威,new List<int>(){0,0,0,5,2,5}},
        {Tag.虎啸龙吟,new List<int>(){0,0,0,9,0,9}},
        {Tag.千人千面,new List<int>(){3,5,3,0,0,0}},
        {Tag.术数纵横,new List<int>(){1,4,4,0,0,0}},
        {Tag.疾如风,new List<int>(){0,0,3,0,0,4}},
        {Tag.恶臭,new List<int>(){-2,-2,-2,1,0,4}},
        {Tag.臭气熏天,new List<int>(){-2,-2,-2,1,0,7}},
        {Tag.机关之躯,new List<int>(){4,0,4,4,0,4}},
    ...
    public static Dictionary<Tag, Rarerity> AllTagRareDict = new Dictionary<Tag, Rarerity>
    {
        ...
        {Tag.淬体,Rarerity.SR},
        {Tag.养神,Rarerity.SSR},
        {Tag.虎虎生威,Rarerity.SSR },
        {Tag.虎啸龙吟,Rarerity.SSR },
        {Tag.千人千面,Rarerity.SSR },
        {Tag.机关之躯,Rarerity.SSR },
        {Tag.恶臭,Rarerity.N},
        {Tag.臭气熏天,Rarerity.R},
        {Tag.铁王八,Rarerity.SR},
        {Tag.术数纵横,Rarerity.SR},
        {Tag.疾如风,Rarerity.SR},

   };
    public readonly static Dictionary<Tag, List<Tag>> MergeTagDict = new Dictionary<Tag, List<Tag>>
    {
       { Tag.弈星下凡,new List<Tag>() { Tag.纵横家, Tag.围棋十段 }},
        { Tag.文武双全,new List<Tag>() { Tag.文, Tag.武, Tag.智勇双全 }},
        ...
        { Tag.徒有虚名,new List<Tag>() { Tag.才华横溢, Tag.略有才名, Tag.花言巧语 }},
        ...
        { Tag.象虎之力,new List<Tag>() { Tag.虎猛, Tag.霸王 }},
        { Tag.嘤嘤狂吠,new List<Tag>() { Tag.独狼, Tag.驯兽大师 }},
        { Tag.武圣,new List<Tag>() { Tag.力拔山兮, Tag.霸王 }},
        { Tag.无影,new List<Tag>() { Tag.出没无常, Tag.金钱镖 }},
        { Tag.磐石,new List<Tag>() { Tag.广厦之荫, Tag.固若金汤 }},
        { Tag.卧龙,new List<Tag>() { Tag.工于心计, Tag.奇门遁甲 }},
        { Tag.诗仙,new List<Tag>() { Tag.才华横溢, Tag.诗兴大发 }},
        { Tag.状元,new List<Tag>() { Tag.书通二酉, Tag.文 }},
        { Tag.文,new List<Tag>() { Tag.文正, Tag.文正 }},
        { Tag.武,new List<Tag>() { Tag.武忠, Tag.武忠 }},
        { Tag.智勇双全,new List<Tag>() { Tag.书痴, Tag.武痴 }},
        ...
        { Tag.霸王,new List<Tag>() { Tag.登堂入室, Tag.走火入魔 }},
        { Tag.景星庆云,new List<Tag>() { Tag.衣不蔽体, Tag.身世悲苦, Tag.厄运缠身 }},
        { Tag.文正,new List<Tag>() { Tag.文贞, Tag.文贞 }},
        { Tag.武忠,new List<Tag>() { Tag.武勇, Tag.武勇 }},
        { Tag.老戏骨,new List<Tag>() { Tag.演员, Tag.年老体衰 }},
        { Tag.书痴,new List<Tag>() { Tag.儒生, Tag.疯子 }},
        { Tag.武痴,new List<Tag>() { Tag.习武之人, Tag.疯子 }},
        { Tag.牧民,new List<Tag>() { Tag.马倌, Tag.驯兽术 }},
        { Tag.欢喜佛,new List<Tag>() { Tag.僧人, Tag.醉酒 }},
        { Tag.恶魔人,new List<Tag>() { Tag.鸠工庀材, Tag.吸血鬼 }},
        { Tag.货郎,new List<Tag>() { Tag.鸠工庀材, Tag.杂七杂八 }},
        { Tag.糖尿病,new List<Tag>() { Tag.营养不良, Tag.嗜甜如命 }},
        { Tag.身世悲苦,new List<Tag>() { Tag.家室美满, Tag.好酒之人, Tag.醉酒 }},
        { Tag.膝盖僵硬,new List<Tag>() { Tag.腿脚不便, Tag.义肢 }},
        { Tag.小有谋略,new List<Tag>() { Tag.棋道, Tag.花言巧语 }},
        { Tag.身形矫健,new List<Tag>() { Tag.飞毛腿, Tag.习武之人 }},
        { Tag.老罴当道,new List<Tag>() { Tag.体态端正, Tag.年老体衰 }},
        { Tag.铁王八,new List<Tag>() { Tag.老罴当道, Tag.皮甲, Tag.铁甲, Tag.护心 }},
        { Tag.虎虎生威,new List<Tag>() { Tag.虎猛, Tag.虎猛 }},
        { Tag.虎啸龙吟,new List<Tag>() { Tag.虎虎生威, Tag.青龙, Tag.龙骑士 }},
        { Tag.箭无虚发,new List<Tag>() { Tag.近视, Tag.弓 }},
        { Tag.平平无奇,new List<Tag>() { Tag.营养不良, Tag.饱腹 }},
        { Tag.吸血鬼,new List<Tag>() { Tag.夜不能寐, Tag.精神病, Tag.不孝子 }},
        { Tag.肥胖症,new List<Tag>() { Tag.干饭人, Tag.糖尿病, Tag.饱腹 }},
        { Tag.无伤大雅,new List<Tag>() { Tag.肥胖症, Tag.习武之人 }},
        { Tag.术数纵横,new List<Tag>() { Tag.双目失明, Tag.心算 }},
        //{ Tag.武痴,new List<Tag>() { Tag.痴呆, Tag.武艺精湛 }},
        { Tag.围棋十段,new List<Tag>() { Tag.奇门遁甲, Tag.术数纵横 }},
        { Tag.身体孱弱,new List<Tag>() { Tag.身怀六甲, Tag.醉酒 }},
        { Tag.六根不净,new List<Tag>() { Tag.身怀六甲, Tag.不孕不育 }},
        { Tag.根骨清奇,new List<Tag>() { Tag.小儿麻痹, Tag.鸿运当头 }},
        { Tag.文化沙漠,new List<Tag>() { Tag.目不识丁, Tag.登堂入室 }},
        { Tag.纸上谈兵,new List<Tag>() { Tag.得寸进尺, Tag.绣花枕头, Tag.偃师 }},
        { Tag.有勇无谋,new List<Tag>() { Tag.无能狂怒, Tag.头疼 }},
        { Tag.气功达人,new List<Tag>() { Tag.半身不遂, Tag.走火入魔 }},
        { Tag.故事王,new List<Tag>() { Tag.磕巴, Tag.花言巧语 }},
        { Tag.冷血无情,new List<Tag>() { Tag.惹人嫌, Tag.不孝子 }},
        { Tag.能歌善舞,new List<Tag>() { Tag.调皮鬼, Tag.梧鼠五技 }},
        { Tag.恶臭,new List<Tag>() { Tag.干呕, Tag.衣不蔽体 }},
        { Tag.疾如风,new List<Tag>() { Tag.长短腿, Tag.飞毛腿, Tag.小有谋略 }},
        { Tag.机关之躯,new List<Tag>() { Tag.义肢, Tag.偃师, Tag.奇门遁甲,Tag.袖炮 }},
        { Tag.半身不遂,new List<Tag>() { Tag.药毒, Tag.糖尿病 }},
        { Tag.臭气熏天,new List<Tag>() { Tag.恶臭, Tag.蛤蟆功 }},
