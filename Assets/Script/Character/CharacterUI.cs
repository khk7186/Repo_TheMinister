...
public class CharacterUI : MonoBehaviour, IPointerClickHandler, IPointerEnterHandler, IPointerExitHandler
{
    ...
    {
        Wisdom.color = TagUIColorCode[character.characterValueRareDict[CharacterValueType.智]];
        Writing.color = TagUIColorCode[character.characterValueRareDict[CharacterValueType.才]];
        Strategy.color = TagUIColorCode[character.characterValueRareDict[CharacterValueType.谋]];
        Strength.color = TagUIColorCode[character.characterValueRareDict[CharacterValueType.武]];
        Sneak.color = TagUIColorCode[character.characterValueRareDict[CharacterValueType.刺]];
        Defense.color = TagUIColorCode[character.characterValueRareDict[CharacterValueType.守]];
    }
