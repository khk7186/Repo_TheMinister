...
public class UISpecForSwitch : TagSpecUI
{
    ...
    public override void SetTagInfo(Tag tag, bool origin = true)
    {
        ...
        //    {
        //        case 0:
        //            output += $"÷«{PlusOrMinus(Player.TagInfDict[tag][0])} ";
        //            break;
        //        case 1:
        //            output += $"≤≈{PlusOrMinus(Player.TagInfDict[tag][1])} ";
        //            break;
        //        case 2:
        //            output += $"ƒ±{PlusOrMinus(Player.TagInfDict[tag][2])} ";
        //            break;
        //        case 3:
        //            output += $"Œ‰{PlusOrMinus(Player.TagInfDict[tag][3])} ";
        //            break;
        //        case 4:
        //            output += $"¥Ã{PlusOrMinus(Player.TagInfDict[tag][4])} ";
        //            break;
        //        case 5:
        //            output += $" ÿ{PlusOrMinus(Player.TagInfDict[tag][5])}";
        //            break;
        //    }
        //}
