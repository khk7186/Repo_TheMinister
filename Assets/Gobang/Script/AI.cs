...
public class AI {
    ...
    public List<GoBangMainLoop.point> count_point(int k) // rank of each point on current board
    {
        List<GoBangMainLoop.point> vp = new List<GoBangMainLoop.point>();
        GoBangMainLoop.point tmp = new GoBangMainLoop.point();
    ...
    public GoBangMainLoop.point select_point()
    {
        List<GoBangMainLoop.point> vp = new List<GoBangMainLoop.point>();
        int i;
        GoBangMainLoop.point point = new GoBangMainLoop.point();
        vp = count_point(2);
        vp.Sort((a, b) =>
        {
            if (a.v > b.v)
